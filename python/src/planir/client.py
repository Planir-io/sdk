...
class PlanirClient:
    ...
    environment : PlanirClientEnvironment
        The environment to use for requests from the client. from .environment import PlanirClientEnvironment



        Defaults to PlanirClientEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: PlanirClientEnvironment = PlanirClientEnvironment.DEFAULT,
    ...
    def runtimes(self):
        if self._runtimes is None:
            from .runtimes.client import RuntimesClient  # noqa: E402
...
class AsyncPlanirClient:
    ...
    def runtimes(self):
        if self._runtimes is None:
            from .runtimes.client import AsyncRuntimesClient  # noqa: E402
