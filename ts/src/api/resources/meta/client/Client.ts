...
export class MetaClient {
     ...
     */
    public getVersion(requestOptions?: MetaClient.RequestOptions): core.HttpResponsePromise<PlanirApi.ApiVersionInfo> {
    ...
    private async __getVersion(
    ...
    ): Promise<core.WithRawResponse<PlanirApi.ApiVersionInfo>> {
        ...
        if (_response.ok) {
            return { data: _response.body as PlanirApi.ApiVersionInfo, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1");
    }
}
