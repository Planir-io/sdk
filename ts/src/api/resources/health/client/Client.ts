...
export class HealthClient {
     ...
     */
    public check(requestOptions?: HealthClient.RequestOptions): core.HttpResponsePromise<PlanirApi.HealthStatus> {
    ...
    private async __check(
    ...
    ): Promise<core.WithRawResponse<PlanirApi.HealthStatus>> {
        ...
        if (_response.ok) {
            return { data: _response.body as PlanirApi.HealthStatus, rawResponse: _response.rawResponse };
        }
